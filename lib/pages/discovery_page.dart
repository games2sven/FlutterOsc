...
import 'package:flutter_osc/pages/common_web_page.dart';
import 'package:flutter_osc/pages/shake_page.dart';
...
class _DiscoveryPageState extends State<DiscoveryPage> {
  ...
  void _navToWebPage(String title, String url) {
    if (title != null && url != null) {
      Navigator.of(context).push(MaterialPageRoute(builder: (context) => CommonWebPage(
        title: title,
        url: url,
      )));
    }
        ...
        return Container(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context,mapIndex){
                return InkWell(
                  onTap: (){
                    _handleItemClick(blocks[bolockIndex].keys.elementAt(mapIndex));
                  },
                  child: Container(
                     height: 60.0,
                    child: ListTile(
                      leading: Icon(blocks[bolockIndex].values.elementAt(mapIndex)),
                      title: Text(blocks[bolockIndex].keys.elementAt(mapIndex)),
